/**
 * earcut — fast polygon triangulation (with hole support).
 * Vendored from github.com/mapbox/earcut (ISC License, © Mapbox).
 * Used to triangulate the cross-section "cap" polygons created when a mesh is
 * sliced by a plane. Handles concave cross-sections and holes, which appear
 * when fracturing non-convex meshes.
 */
...
function Node(i, x, y) {
  ...
  this.prev = null; this.next = null; this.z = 0; this.prevZ = null; this.nextZ = null; this.steiner = false;
}
